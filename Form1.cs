...
namespace WinForms_AsyncOps_Example
{
    ...
    public partial class Form1 : Form
    {
        ...
        /// All you need to do is calling methods or fire further events. In this case we just call/start the Running Task. The Task is discarded after calling.
        /// </summary>
        /// <param name="sender">The Button</param>
        /// <param name="e">Standard EventArgs, nothing to worry about</param>
        private void Button1_Click(object sender, EventArgs e) => _ = LongRunningAsync();

        /// <summary>
        /// Marked async to tell the compiler we are awaiting something in this method
        /// Executes the LongRunning Task in an asynchronous manner and manipulates the Controls of the Form.
        /// First there is inverted check if input is only digits using Regular Expression + not larger than 4 digits to avoid computing unnecessary long inputs.
        /// The result of called Task DoLongRunningWithProgressReporting() is returned in a Try-Catch-Construction.
        /// Instead of throwing exception the error ist simply print in a popup box (Not tested if generic Exception fits).
        /// You can see the result is awaited asynchronously so the app isn't blocked, the actual purpose of this example.
        /// This method is not atomic, but since it returns just a Task it should be able to be unittested.
        /// </summary>
        ...
        /// This method is not atomic in a sense that it does more than one thing, but since the actual operation is wrapped inside the other it should be able to be unittested.
        /// </summary>
